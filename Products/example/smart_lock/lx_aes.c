 ...
 * 从左到右依次排列。
 */
static void convertToIntArray(unsigned char *str, int pa[4][4]) {
    int k = 0,i=0,j=0;
    for(i = 0; i < 4; i++)
        for(j = 0; j < 4; j++) {
 ...
 * 把连续的4个字符合并成一个4字节的整型
 */
static int getWordFromStr(unsigned char *str) 
{
 ...
 * 参数 key: 密钥的字符串数组。
 */
void aes(unsigned char *p, int plen, unsigned char *key){
 ...
 * 参数 key: 密钥的字符串数组。
 */
void deAes(unsigned char *c, int clen, unsigned char *key) {
...
//{ 
//	char key[16] = {0x06, 0x01, 0x04, 0x07, 0x01, 0x04, 0x07, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
//	int klen;
//	char p[16]={0x06, 0x08, 0x04, 0x05, 0x05, 0x09, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
//	int plen = sizeof(p);
//	printf("AES...ing..................\n");
//	if(plen == 0) 
//	{
